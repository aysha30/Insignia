...
function Footer() {
    return (
        <>
            ...
            <div className='grid grid-col-auto lg:grid-cols-4 flex flex-wrap items-start justify-items-start flex-grow mt-10'>
                ...
                <div className='flex flex-col pl-4'>
                    <div className='text-md text-blue font-thin break-words pb-5'>
                        Social Media<br />
                    </div>
                    <div className='flex flex-row'>
                        <div className='p-2.5'>
                            <button className='rounded-4xl shadow shadow-gray-800'>
                                <svg className="h-16 w-16" viewBox="0 0 25 25" strokeWidth={0} fill="#e0e0e0" xmlns="http://www.w3.org/2000/svg">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 2c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-2 10h-2v2h2v6h3v-6h1.82l.18-2h-2v-.833c0-.478.096-.667.558-.667h1.442v-2.5h-2.404c-1.798 0-2.596.792-2.596 2.308v1.692z" />
                                </svg>
                            </button>
                        </div>
                        <div className='p-2.5'>
            ...
            <div className='text-xxs text-blue font-thin break-words pb-5'>
